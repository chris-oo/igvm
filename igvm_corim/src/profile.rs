...
//! draft-ietf-rats-corim-10 §4.1.4. A profile constrains the base CoRIM
...
//! **lowercase** hyphenated string per RFC 9562 §4:
//!
//! ```text
...
//!   `UUIDv5(TAG_ID_NAMESPACE, "{vendor}/{model}")` per RFC 9562 §4.
